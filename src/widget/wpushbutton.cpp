...
void WPushButton::timeupdate()
{
    ...
    m_ntime = time.toTime_t() - m_ntimeStart;   //将当前时间转为时间戳
     ...
     if(m_ntime > 1)
     {
         ...
         QMouseEvent pressEvent(QEvent::MouseButtonPress, QPointF(m_size.width()/2, m_size.height()/2), Qt::RightButton, Qt::RightButton, Qt::NoModifier);
         QApplication::sendEvent(this, &pressEvent);

         QMouseEvent releaseEvent(QEvent::MouseButtonRelease, QPointF(m_size.width()/2, m_size.height()/2), Qt::RightButton, Qt::RightButton, Qt::NoModifier);
     ...
     else
     {
         ...
         QMouseEvent pressEvent(QEvent::MouseButtonPress, QPointF(m_size.width()/2, m_size.height()/2), Qt::LeftButton, Qt::LeftButton, Qt::NoModifier);
         QApplication::sendEvent(this, &pressEvent);

         QMouseEvent releaseEvent(QEvent::MouseButtonRelease, QPointF(m_size.width()/2, m_size.height()/2), Qt::LeftButton, Qt::LeftButton, Qt::NoModifier);
         QApplication::sendEvent(this, &releaseEvent);
     }
     m_timer->stop();
}
